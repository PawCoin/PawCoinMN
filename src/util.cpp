...
int nAnonymizePawcoinAmount = 500;
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "PawcoinMN";
#else
    fs::path pathRet;
...
void createConf()       //Automatic Pawcoin.conf generation
{
    ...
    const char* nodes =  "\nport=32390"
                        ...
                        "\ndaemon=1"
                        "\nserver=1"
                        "\naddnode=5.189.183.249:32390"
                        "\naddnode=54.36.63.180:32390";
