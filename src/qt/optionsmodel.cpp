...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizePawcoinAmount"))
        settings.setValue("nAnonymizePawcoinAmount", 1000);

    nDarksendRounds = settings.value("nDarksendRounds").toLongLong();
    nAnonymizePawcoinAmount = settings.value("nAnonymizePawcoinAmount").toLongLong();
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case anonymizePawcoinAmount:
            nAnonymizePawcoinAmount = value.toInt();
            settings.setValue("nAnonymizePawcoinAmount", nAnonymizePawcoinAmount);
            emit anonymizePawcoinAmountChanged(nAnonymizePawcoinAmount);
            break;
        default:
            break;
        }
