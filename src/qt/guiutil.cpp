...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("Pawcoin://"))
    {
        uri.replace(0, 12, "Pawcoin:");
    }
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Pawcoin.lnk";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("Pawcoin-Qt") + " " + tr("version") + " " +
